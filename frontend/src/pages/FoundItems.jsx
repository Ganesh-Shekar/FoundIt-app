  ...
  return (
    <div className="max-w-6xl mx-auto p-8 bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen">
      ...
      <p className="text-center text-gray-500 mb-10 max-w-2xl mx-auto">
        Browse through items that have been found and reported. If something belongs to you, get in touch!
      </p>
          ...
          {items.map((item) => (
            ...
            >
              <div className="flex justify-between items-start mb-3">
                ...
                <span className="bg-green-100 text-green-600 text-xs font-medium px-2.5 py-0.5 rounded-full">Found</span>
              </div>
